...
class ViewPessoa(object):
    ...
    def adicionaFinanca(self,financa):
        ...
        spaceMesInicial = 28 - sizeMesInicial

        sizeMesAtual = len(str(financa._mesAtual_))
        spaceMesAtual = 30 - sizeMesAtual
        ...
        self._financaListBox_.insert(END, financa._nomeGasto_+" "*spaceNome+ str(financa._numPrestacao_)+" "*spaceNumPrestacao+str(financa._mesInicial_)+" "*spaceMesInicial+str(financa._mesAtual_)+" "*spaceMesAtual+ str(round(valorPorMes, 2)) + " "*spaceMesAtual+str(round(financa._total_, 2)))
    ...
    def __init__(self,comandoinserir,comandocarregar,relatorio):
        ...
        self._totMesLabel_      = Label(master=self._totMesLabel_, text="")
        ...
        self._financaListBox_ = Listbox(master=self._janelaPrincipal_, width =100)
        ...
        self._totMesLabel_.grid(row=9, column=2)
